...
| | [aswf/ci-common:6](https://hub.docker.com/r/aswf/ci-common/tags?name=6) ![Image Version](https://img.shields.io/docker/v/aswf/ci-common/6) | ![Image Size](https://img.shields.io/docker/image-size/aswf/ci-common/6) ![Pulls](https://img.shields.io/docker/pulls/aswf/ci-common) | A base RockyLinux-8 image with gcc-toolset-14 (GCC-14.2.x), clang-19-20 and cuda-12.9.2. |
| | [aswf/ci-common:7](https://hub.docker.com/r/aswf/ci-common/tags?name=7) ![Image Version](https://img.shields.io/docker/v/aswf/ci-common/7) | ![Image Size](https://img.shields.io/docker/image-size/aswf/ci-common/7) ![Pulls](https://img.shields.io/docker/pulls/aswf/ci-common) | A base RockyLinux-9 image with gcc-toolset-14 (GCC-14.2.x), clang-21-22 and cuda-13.3.0. |
| [aswf/ci-base](https://hub.docker.com/r/aswf/ci-base) | [aswf/ci-base:2023](https://hub.docker.com/r/aswf/ci-base/tags?name=2023) ![Image Version](https://img.shields.io/docker/v/aswf/ci-base/2023) | ![Image Size](https://img.shields.io/docker/image-size/aswf/ci-base/2023) ![Pulls](https://img.shields.io/docker/pulls/aswf/ci-base) | Based on `aswf/ci-common:3` with most VFX Platform requirements pre-installed. |
...
| | [aswf/ci-base:2027](https://hub.docker.com/r/aswf/ci-base/tags?name=2027) ![Image Version](https://img.shields.io/docker/v/aswf/ci-base/2027) | ![Image Size](https://img.shields.io/docker/image-size/aswf/ci-base/2027) ![Pulls](https://img.shields.io/docker/pulls/aswf/ci-base) | Based on `aswf/ci-common:7` with most VFX Platform requirements pre-installed. |
| [aswf/ci-baseqt](https://hub.docker.com/r/aswf/ci-baseqt) | [aswf/ci-baseqt:2023](https://hub.docker.com/r/aswf/ci-baseqt/tags?name=2023) ![Image Version](https://img.shields.io/docker/v/aswf/ci-baseqt/2023) | ![Image Size](https://img.shields.io/docker/image-size/aswf/ci-baseqt/2023) ![Pulls](https://img.shields.io/docker/pulls/aswf/ci-baseqt) | Based on `aswf/ci-common:3` with most VFX Platform requirements pre-installed with Qt and PySide. |
...
| | [aswf/ci-baseqt:2027](https://hub.docker.com/r/aswf/ci-baseqt/tags?name=2027) ![Image Version](https://img.shields.io/docker/v/aswf/ci-baseqt/2027) | ![Image Size](https://img.shields.io/docker/image-size/aswf/ci-baseqt/2027) ![Pulls](https://img.shields.io/docker/pulls/aswf/ci-baseqt) | Based on `aswf/ci-common:7` with most VFX Platform requirements pre-installed with Qt and PySide. |
| [aswf/ci-imath](https://hub.docker.com/r/aswf/ci-imath) | [aswf/ci-imath:2023](https://hub.docker.com/r/aswf/ci-imath/tags?name=2023) ![Image Version](https://img.shields.io/docker/v/aswf/ci-imath/2023) | ![Image Size](https://img.shields.io/docker/image-size/aswf/ci-imath/2023) ![Pulls](https://img.shields.io/docker/pulls/aswf/ci-imath) | Based on `aswf/ci-common:3`, comes with all Imath upstream dependencies pre-installed. |
| | [aswf/ci-imath:2024](https://hub.docker.com/r/aswf/ci-imath/tags?name=2024) ![Image Version](https://img.shields.io/docker/v/aswf/ci-imath/2024) | ![Image Size](https://img.shields.io/docker/image-size/aswf/ci-imath/2024) ![Pulls](https://img.shields.io/docker/pulls/aswf/ci-imath) | Based on `aswf/ci-common:4`, comes with all Imath upstream dependencies pre-installed. |
...
| | [aswf/ci-imath:2027](https://hub.docker.com/r/aswf/ci-imath/tags?name=2027) ![Image Version](https://img.shields.io/docker/v/aswf/ci-imath/2027) | ![Image Size](https://img.shields.io/docker/image-size/aswf/ci-imath/2027) ![Pulls](https://img.shields.io/docker/pulls/aswf/ci-imath) | Based on `aswf/ci-common:7`, comes with all Imath upstream dependencies pre-installed. |
| [aswf/ci-openexr](https://hub.docker.com/r/aswf/ci-openexr) | [aswf/ci-openexr:2023](https://hub.docker.com/r/aswf/ci-openexr/tags?name=2023) ![Image Version](https://img.shields.io/docker/v/aswf/ci-openexr/2023) | ![Image Size](https://img.shields.io/docker/image-size/aswf/ci-openexr/2023) ![Pulls](https://img.shields.io/docker/pulls/aswf/ci-openexr) | Based on `aswf/ci-common:3`, comes with all Imath and OpenEXR upstream dependencies pre-installed. |
...
| | [aswf/ci-openexr:2026](https://hub.docker.com/r/aswf/ci-openexr/tags?name=2027) ![Image Version](https://img.shields.io/docker/v/aswf/ci-openexr/2027) | ![Image Size](https://img.shields.io/docker/image-size/aswf/ci-openexr/2027) ![Pulls](https://img.shields.io/docker/pulls/aswf/ci-openexr) | Based on `aswf/ci-common:7`, comes with all OpenEXR upstream dependencies pre-installed. |
| [aswf/ci-ocio](https://hub.docker.com/r/aswf/ci-ocio) | [aswf/ci-ocio:2023](https://hub.docker.com/r/aswf/ci-ocio/tags?name=2023) ![Image Version](https://img.shields.io/docker/v/aswf/ci-ocio/2023) | ![Image Size](https://img.shields.io/docker/image-size/aswf/ci-ocio/2023) ![Pulls](https://img.shields.io/docker/pulls/aswf/ci-ocio) | Based on `aswf/ci-common:3`, comes with all OpenColorIO upstream dependencies pre-installed. |
...
| | [aswf/ci-ocio:2027](https://hub.docker.com/r/aswf/ci-ocio/tags?name=2027) ![Image Version](https://img.shields.io/docker/v/aswf/ci-ocio/2027) | ![Image Size](https://img.shields.io/docker/image-size/aswf/ci-ocio/2027) ![Pulls](https://img.shields.io/docker/pulls/aswf/ci-ocio) | Based on `aswf/ci-common:7`, comes with all OpenColorIO upstream dependencies pre-installed. |
| [aswf/ci-opencue](https://hub.docker.com/r/aswf/ci-opencue) | [aswf/ci-opencue:2023](https://hub.docker.com/r/aswf/ci-opencue/tags?name=2023) ![Image Version](https://img.shields.io/docker/v/aswf/ci-opencue/2023) | ![Image Size](https://img.shields.io/docker/image-size/aswf/ci-opencue/2023) ![Pulls](https://img.shields.io/docker/pulls/aswf/ci-opencue) | Based on `aswf/ci-common:3`, comes with all OpenCue upstream dependencies pre-installed. |
...
| | [aswf/ci-opencue:2027](https://hub.docker.com/r/aswf/ci-opencue/tags?name=2027) ![Image Version](https://img.shields.io/docker/v/aswf/ci-opencue/2027) | ![Image Size](https://img.shields.io/docker/image-size/aswf/ci-opencue/2027) ![Pulls](https://img.shields.io/docker/pulls/aswf/ci-opencue) | Based on `aswf/ci-common:7`, comes with all OpenCue upstream dependencies pre-installed. |
| [aswf/ci-openvdb](https://hub.docker.com/r/aswf/ci-openvdb) | [aswf/ci-openvdb:2023](https://hub.docker.com/r/aswf/ci-openvdb/tags?name=2023) ![Image Version](https://img.shields.io/docker/v/aswf/ci-openvdb/2023) | ![Image Size](https://img.shields.io/docker/image-size/aswf/ci-openvdb/2023) ![Pulls](https://img.shields.io/docker/pulls/aswf/ci-openvdb) | Based on `aswf/ci-common:3`, comes with all OpenVDB upstream dependencies pre-installed. |
...
| | [aswf/ci-openvdb:2027](https://hub.docker.com/r/aswf/ci-openvdb/tags?name=2027) ![Image Version](https://img.shields.io/docker/v/aswf/ci-openvdb/2027) | ![Image Size](https://img.shields.io/docker/image-size/aswf/ci-openvdb/2027) ![Pulls](https://img.shields.io/docker/pulls/aswf/ci-openvdb) | Based on `aswf/ci-common:7`, comes with all OpenVDB upstream dependencies pre-installed. |
| [aswf/ci-otio](https://hub.docker.com/r/aswf/ci-otio) | [aswf/ci-otio:2023](https://hub.docker.com/r/aswf/ci-otio/tags?name=2023) ![Image Version](https://img.shields.io/docker/v/aswf/ci-otio/2023) | ![Image Size](https://img.shields.io/docker/image-size/aswf/ci-otio/2023) ![Pulls](https://img.shields.io/docker/pulls/aswf/ci-otio) | Based on `aswf/ci-common:3`, comes with all OpenTimelineIO upstream dependencies pre-installed. |
...
| | [aswf/ci-otio:2027](https://hub.docker.com/r/aswf/ci-otio/tags?name=2027) ![Image Version](https://img.shields.io/docker/v/aswf/ci-otio/2027) | ![Image Size](https://img.shields.io/docker/image-size/aswf/ci-otio/2027) ![Pulls](https://img.shields.io/docker/pulls/aswf/ci-otio) | Based on `aswf/ci-common:7`, comes with all OpenTimelineIO upstream dependencies pre-installed. |
| [aswf/ci-oiio](https://hub.docker.com/r/aswf/ci-oiio) | [aswf/ci-oiio:2023](https://hub.docker.com/r/aswf/ci-oiio/tags?name=2023) ![Image Version](https://img.shields.io/docker/v/aswf/ci-oiio/2023) | ![Image Size](https://img.shields.io/docker/image-size/aswf/ci-oiio/2023) ![Pulls](https://img.shields.io/docker/pulls/aswf/ci-oiio) | Based on `aswf/ci-common:3`, comes with all OpenImageIO upstream dependencies pre-installed. |
| | [aswf/ci-oiio:2024](https://hub.docker.com/r/aswf/ci-oiio/tags?name=2024) ![Image Version](https://img.shields.io/docker/v/aswf/ci-oiio/2024) | ![Image Size](https://img.shields.io/docker/image-size/aswf/ci-oiio/2024) ![Pulls](https://img.shields.io/docker/pulls/aswf/ci-oiio) | Based on `aswf/ci-common:4`, comes with all OpenImageIO upstream dependencies pre-installed. |
...
| | [aswf/ci-oiio:2027](https://hub.docker.com/r/aswf/ci-oiio/tags?name=2027) ![Image Version](https://img.shields.io/docker/v/aswf/ci-oiio/2027) | ![Image Size](https://img.shields.io/docker/image-size/aswf/ci-oiio/2027) ![Pulls](https://img.shields.io/docker/pulls/aswf/ci-oiio) | Based on `aswf/ci-common:7`, comes with all OpenImageIO upstream dependencies pre-installed. |
...
| | [aswf/ci-materialx:2027](https://hub.docker.com/r/aswf/ci-materialx/tags?name=2027) ![Image Version](https://img.shields.io/docker/v/aswf/ci-materialx/2027) | ![Image Size](https://img.shields.io/docker/image-size/aswf/ci-materialx/2027) ![Pulls](https://img.shields.io/docker/pulls/aswf/ci-materialx) | Based on `aswf/ci-common:7`, comes with all MaterialX upstream dependencies pre-installed. |
| [aswf/ci-usd](https://hub.docker.com/r/aswf/ci-usd) | [aswf/ci-usd:2023](https://hub.docker.com/r/aswf/ci-usd/tags?name=2023) ![Image Version](https://img.shields.io/docker/v/aswf/ci-usd/2023) | ![Image Size](https://img.shields.io/docker/image-size/aswf/ci-usd/2023) ![Pulls](https://img.shields.io/docker/pulls/aswf/ci-usd) | Based on `aswf/ci-common:3`, comes with all OpenUSD upstream dependencies pre-installed. |
...
| | [aswf/ci-usd:2027](https://hub.docker.com/r/aswf/ci-usd/tags?name=2027) ![Image Version](https://img.shields.io/docker/v/aswf/ci-usd/2027) | ![Image Size](https://img.shields.io/docker/image-size/aswf/ci-usd/2027) ![Pulls](https://img.shields.io/docker/pulls/aswf/ci-usd) | Based on `aswf/ci-common:7`, comes with all OpenUSD upstream dependencies pre-installed. |
| [aswf/ci-osl](https://hub.docker.com/r/aswf/ci-osl) | [aswf/ci-osl:2023](https://hub.docker.com/r/aswf/ci-osl/tags?name=2023) ![Image Version](https://img.shields.io/docker/v/aswf/ci-osl/2023) | ![Image Size](https://img.shields.io/docker/image-size/aswf/ci-osl/2023) ![Pulls](https://img.shields.io/docker/pulls/aswf/ci-osl) | Based on `aswf/ci-common:3`, comes with all OpenShadingLanguage upstream dependencies pre-installed. |
...
| | [aswf/ci-osl:2027](https://hub.docker.com/r/aswf/ci-osl/tags?name=2027) ![Image Version](https://img.shields.io/docker/v/aswf/ci-osl/2027) | ![Image Size](https://img.shields.io/docker/image-size/aswf/ci-osl/2027) ![Pulls](https://img.shields.io/docker/pulls/aswf/ci-osl) | Based on `aswf/ci-common:7`, comes with all OpenShadingLanguage upstream dependencies pre-installed. |
...
| | [aswf/ci-openrv:2027](https://hub.docker.com/r/aswf/ci-openrv/tags?name=2027) ![Image Version](https://img.shields.io/docker/v/aswf/ci-openrv/2027) | ![Image Size](https://img.shields.io/docker/image-size/aswf/ci-openrv/2027) ![Pulls](https://img.shields.io/docker/pulls/aswf/ci-openrv) | Based on `aswf/ci-common:7`, comes with all OpenRV upstream dependencies pre-installed. |
| [aswf/ci-openfx](https://hub.docker.com/r/aswf/ci-openfx) | [aswf/ci-openfx:2023](https://hub.docker.com/r/aswf/ci-openfx/tags?name=2023) ![Image Version](https://img.shields.io/docker/v/aswf/ci-openfx/2023) | ![Image Size](https://img.shields.io/docker/image-size/aswf/ci-openfx/2023) ![Pulls](https://img.shields.io/docker/pulls/aswf/ci-openfx) | Based on `aswf/ci-common:3`, comes with all OpenFX upstream dependencies pre-installed. |
| | | [aswf/ci-openfx:2024](https://hub.docker.com/r/aswf/ci-openfx/tags?name=2024) ![Image Version](https://img.shields.io/docker/v/aswf/ci-openfx/2024) | ![Image Size](https://img.shields.io/docker/image-size/aswf/ci-openfx/2024) ![Pulls](https://img.shields.io/docker/pulls/aswf/ci-openfx) | Based on `aswf/ci-common:4`, comes with all OpenFX upstream dependencies pre-installed. |
...
| | [aswf/ci-openfx:2027](https://hub.docker.com/r/aswf/ci-openfx/tags?name=2027) ![Image Version](https://img.shields.io/docker/v/aswf/ci-openfx/2027) | ![Image Size](https://img.shields.io/docker/image-size/aswf/ci-openfx/2027) ![Pulls](https://img.shields.io/docker/pulls/aswf/ci-openfx) | Based on `aswf/ci-common:7`, comes with all OpenFX upstream dependencies pre-installed. |
| [aswf/ci-rawtoaces](https://hub.docker.com/r/aswf/ci-rawtoaces) | [aswf/ci-rawtoaces:2023](https://hub.docker.com/r/aswf/ci-rawtoaces/tags?name=2023) ![Image Version](https://img.shields.io/docker/v/aswf/ci-rawtoaces/2023) | ![Image Size](https://img.shields.io/docker/image-size/aswf/ci-rawtoaces/2023) ![Pulls](https://img.shields.io/docker/pulls/aswf/ci-rawtoaces) | Based on `aswf/ci-common:3`, comes with all rawtoaces upstream dependencies pre-installed. |
...
| | [aswf/ci-rawtoaces:2027](https://hub.docker.com/r/aswf/ci-rawtoaces/tags?name=2027) ![Image Version](https://img.shields.io/docker/v/aswf/ci-rawtoaces/2027) | ![Image Size](https://img.shields.io/docker/image-size/aswf/ci-rawtoaces/2027) ![Pulls](https://img.shields.io/docker/pulls/aswf/ci-rawtoaces) | Based on `aswf/ci-common:7`, comes with all rawtoaces upstream dependencies pre-installed. |
...
| | [aswf/ci-xstudio:2027](https://hub.docker.com/r/aswf/ci-xstudio/tags?name=2027) ![Image Version](https://img.shields.io/docker/v/aswf/ci-xstudio/2027) | ![Image Size](https://img.shields.io/docker/image-size/aswf/ci-xstudio/2027) ![Pulls](https://img.shields.io/docker/pulls/aswf/ci-xstudio) | Based on `aswf/ci-common:7`, comes with all xSTUDIO upstream dependencies pre-installed. |
| [aswf/ci-vfxall](https://hub.docker.com/r/aswf/ci-vfxall) | [aswf/ci-vfxall:2023](https://hub.docker.com/r/aswf/ci-vfxall/tags?name=2023) ![Image Version](https://img.shields.io/docker/v/aswf/ci-vfxall/2023) | ![Image Size](https://img.shields.io/docker/image-size/aswf/ci-vfxall/2023) ![Pulls](https://img.shields.io/docker/pulls/aswf/ci-vfxall) | Based on `aswf/ci-common:3`, comes with most VFX packages pre-installed. |
...
| | [aswf/ci-vfxall:2027](https://hub.docker.com/r/aswf/ci-vfxall/tags?name=2027) ![Image Version](https://img.shields.io/docker/v/aswf/ci-vfxall/2027) | ![Image Size](https://img.shields.io/docker/image-size/aswf/ci-vfxall/2027) ![Pulls](https://img.shields.io/docker/pulls/aswf/ci-vfxall) | Based on `aswf/ci-common:7`, comes with most VFX packages pre-installed. |

### Versions

The `ASWF_VFXPLATFORM_VERSION` is the calendar year mentioned in the
VFX Platform, e.g. `2026`.
...
e.g. `2026.0` would be followed if necessary by a `2026.1` version.
...
`aswf/ci-base:2026.0`, but it is recommended to use the
...
`aswf/ci-openexr:latest` points to `aswf/ci-openexr:2026.0` but will be
updated to point to `aswf/ci-openexr:2027.0` in the calendar year 2027.
...
As of June 2026 there are full 2023, 2024, 2025, 2026 and 2027 [VFX Platform](https://vfxplatform.com) compliant images.
