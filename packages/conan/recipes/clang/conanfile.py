...
#
# From: https://github.com/conan-io/conan-center-index/blob/3375dfbcae9df4cee7b4eb6323b584fb60a2c8d0/recipes/llvm-core/all/conanfile.py
...
class ClangConan(ConanFile):
    # ASWF: upstream recipe only builds llvm, we build llvm + clang
    name = "clang"
    description = (
    ...
    def package(self):
        # ASWF: license files in package specific folder
        copy(self, "LICENSE.TXT", self._llvm_source_folder_path, self._package_folder_path / "licenses" / self.name)
        cmake = CMake(self)
        cmake.install()
