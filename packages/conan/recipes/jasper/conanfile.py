...
#
# From: https://github.com/conan-io/conan-center-index/blob/1ce15d41e0301e69706f20bf3d6d942221d8baae/recipes/jasper/all/conanfile.py
...
class JasperConan(ConanFile):
    ...
    def requirements(self):
        if self.options.with_libjpeg == "libjpeg":
            ...
            self.requires("libjpeg-turbo/[>=3.0.2 <4]", transitive_libs=True) # ASWF: force DSO to be found
