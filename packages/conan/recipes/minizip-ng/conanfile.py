...
#
# From: https://github.com/conan-io/conan-center-index/blob/1ce15d41e0301e69706f20bf3d6d942221d8baae/recipes/minizip-ng/all/conanfile.py
...
class MinizipNgConan(ConanFile):
    ...
    default_options = {
        ...
        "with_openssl": True,
        "with_iconv": True,
        "with_libbsd": False, # ASWF: we don't have libbsd
        "with_libcomp": True,
    }
