...
class SpdlogConan(ConanFile):
    ...
    default_options = {
        "shared": False,
        "fPIC": True,
        "header_only": True, # OpenFX expects header_only version
        "wchar_support": False,
    ...
    def package(self):
        # ASWF: license in package specific dir
        copy(self, "LICENSE", dst=os.path.join(self.package_folder, "licenses", self.name), src=self.source_folder)
        if self.options.header_only:
            copy(self,
