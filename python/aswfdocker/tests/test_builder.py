                ...
                "target": {
                    "ci-openvdb-2019-clang9": {
                        "args": {
                            ...
                            "ASWF_OPENCOLORIO_CONFIGS_VERSION": "1.0_r2",
                            "ASWF_OPENCOLORIO_VERSION": "1.1.0",
                            "ASWF_OPENIMAGEIO_VERSION": "2.0.8",
                ...
                "target": {
                    "ci-base-2020": {
                        ...
                        "args": {
                            ...
                            "ASWF_OPENCOLORIO_CONFIGS_VERSION": "1.0_r2",
                            "ASWF_OPENCOLORIO_VERSION": "1.1.1",
                            "ASWF_OPENIMAGEIO_VERSION": "2.1.13.0",
...
class TestBuilderCli(unittest.TestCase):
    ...
    def test_builder_cli_allversions(self):
        ...
        bake_path = os.path.join(
            ...
            "-5-clang18-5-clang19-6-clang19-6-clang20"
            "-7-clang21-7-clang22.json",
        )
        cmd = f"docker buildx bake -f {bake_path} --progress auto"
        self.assertEqual(
            result.output,
